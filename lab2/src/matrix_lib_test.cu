...
int main(int argc, char *argv[]) {
    ...
    // opções
    char short_options[] = "s:r:c:C:m:M:o:O:t:g:";
    struct option long_options[] = {
        ...
        {"output1", 1, NULL, 'o'},
        {"output2", 1, NULL, 'O'},
        {"threadsperblock", 1, NULL, 't'},
        {"blockspergrid", 1, NULL, 'g'},
        {NULL, 0, NULL, 0}
    };
    char ch;
    ...
    while((ch=getopt_long(argc, argv, short_options, long_options, NULL)) != -1) {
        switch(ch) {
            ...
            case 'c':
                ...
                break;
            case 'g':
                blocksPerGrid = strtol(optarg, NULL, 10);
                break;
            case 'M':
            ...
            case 's':
                ...
                break;
            case 't':
                threadsPerBlock = strtol(optarg, NULL, 10);
                break;
            default:
...
void usage(const char *name) {
    ...
    printf("-t --threadsperblock    number of threads per block\n");
    printf("-g --blockspergrid      number of blocks per grid\n");
}
